...
;; Package-Commit: 0d9fbee337cb8dd316e5dcf0bff91e44c115dd0d
;; Version: 0.3.0
  ...
  (setq
   ...
   (websocket-open
    ...
    (lambda (_ws)
      ...
      (push (json-encode grammarly--init-msg) my/grammarly-open-data)
      (push (json-encode (grammarly--form-check-request grammarly--text)) my/grammarly-open-data)
